...
void OakKeywordLexingPattern :: AddLocalization ( const OakKeywords :: KeywordLocalization & Localization, uint64_t LocalizationIndex, bool Overwrite )
{
	...
	KeywordAuxTags.Set ( Localization.Alias.c_str (), Localization.Alias.size (), ( LocalizationIndex << OakKeywordTokenTags :: kKeywordAuxTags_Shift_Localization ) | OakKeywordTokenTags :: kKeywordAuxTags_Alias, Overwrite );
	KeywordAuxTags.Set ( Localization.Other.c_str (), Localization.Other.size (), ( LocalizationIndex << OakKeywordTokenTags :: kKeywordAuxTags_Shift_Localization ) | OakKeywordTokenTags :: kKeywordAuxTags_Other, Overwrite );
